        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoUri = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Corporations_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPermissionDays = table.Column<int>(type: "int", nullable: true),
                    UsingPermissionDays = table.Column<int>(type: "int", nullable: true),
                    AdvancePaymentLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AdvanceUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    CorparationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Corporations_CorparationId",
                        column: x => x.CorparationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdvancePayment_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestPermissionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PermissionStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PermissionEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PermissionDays = table.Column<int>(type: "int", nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvancePayment_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CorparationId",
                table: "AspNetUsers",
                column: "CorparationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Corporations_PackageId",
                table: "Corporations",
                column: "PackageId");
